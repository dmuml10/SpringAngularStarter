...
export class UsersComponent extends AbstractComponent implements OnInit {
	...
	private initFilter(id: number, username: string, email: string, name: string, status: string): void {
		this.filter = {};
		super.initPagingFilter(this.filter);
		this.initFilterFields(id, username, email, name, status);
	}

	private initFilterFields(id: number, username: string, email: string, name: string, status: string): void {
		this.filter.id = id;
	...
	private initLazyFilter(event: LazyLoadEvent, id: number, username: string, email: string, name: string, status: string): void {
		this.filter = {};
